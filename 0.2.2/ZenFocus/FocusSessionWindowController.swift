...
class FocusSessionWindowController: NSWindowController {
    ...
    var dailyFocusManager: DailyFocusManager
    
    init(task: ZenFocusTask, windowManager: WindowManager, dailyFocusManager: DailyFocusManager) {
        self.task = task
        ...
        let contentView = FocusSessionView(task: task, dailyFocusManager: dailyFocusManager, windowController: self)
