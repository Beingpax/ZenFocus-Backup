...
struct BreakTimerView: View {
    ...
    init(breakTimeRemaining: Binding<Int>, showBreakTimer: Binding<Bool>, onStartNextTask: @escaping () -> Void, onDismissAll: @escaping () -> Void, nextTask: ZenFocusTask?, dismissing: Binding<Bool>) {
