...
class AnalyticsService: ObservableObject {
    ...
    func trackDiscordInviteShown(source: String) {
        trackEvent("discord_invite_shown", properties: ["source": source])
    }

    func trackDiscordInviteJoin() {
        trackEvent("discord_invite_join")
    }

    func trackDiscordInviteMaybeLater() {
        trackEvent("discord_invite_maybe_later")
    }
