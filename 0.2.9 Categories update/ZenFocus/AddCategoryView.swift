...
struct AddCategoryView: View {
    ...
    private func addCategory() {
        do {
            ...
            if categoryManager.isDuplicateName(newCategoryName, parent: parentCategory) {
                throw CategoryError.duplicateName(newCategoryName)
            }
            
            if isParentCategory {
                try categoryManager.addParentCategory(newCategoryName, color: selectedColor)
            } else {
                try categoryManager.addChildCategory(newCategoryName, parent: parentCategory!, color: selectedColor)
            }
            
            ZenFocusLogger.shared.info("Category added successfully: \(newCategoryName)")
